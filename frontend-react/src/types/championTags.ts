...
export const championTags: Record<string, ChampionTags> = {
  ...
  Kennen: { damageTypes: ["magic-damage"], tags: ["dash", "strong-ultimate"] },
  ...
  Lillia: { damageTypes: ["magic-damage", "true-damage"], tags: ["dash", "healing"] },
  Lissandra: {
    damageTypes: ["magic-damage"],
    tags: ["dash", "cc", "strong-ultimate"],
    strongAgainst: ["assassin"],
  ...
  Maokai: { damageTypes: ["magic-damage"], tags: ["dash", "healing", "cc", "strong-ultimate"] },
  MasterYi: {
    damageTypes: ["physical-damage", "true-damage"],
    tags: ["dash", "healing"],
  },
  ...
  Morgana: { damageTypes: ["magic-damage"], strongAgainst: ["cc"] },
